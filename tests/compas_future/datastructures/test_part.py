...
from compas_future.datastructures.assembly.part import MeshGeometry, MeshFeature
...
def test_add_feature(mocker, part_polyhedron, feature_polyhedron):
    ...
    mocker.patch("compas_future.datastructures.assembly.part.MeshFeature._apply_feature")
